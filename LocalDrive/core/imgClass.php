<?php
/*
 * Source : http://www.grafikart.fr/tutoriels/php/gestion-images-php-52
 * Cette classe permet d'effectuer créer une miniature à partir d'un image. 
 * Elle redimensionne et regnie l'image afin de garder les mêmes proportions.
 */
class Img{
